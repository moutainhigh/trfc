...
import com.tianrui.web.api.util.HttpPostUtil;
import com.tianrui.web.api.util.WebApiConstant;
...
public class ApiStaticAction {
	...
	public String login(String p){
		String rs =HttpPostUtil.getInstance().post(WebApiConstant.URL_PRE+"login", "p="+p);
...
//	@ResponseBody
//	public String updatePswd(String param){
