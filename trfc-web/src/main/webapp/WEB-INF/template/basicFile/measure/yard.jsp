					...
					<div class="intel_search">
						...
						<div class="intel_sconditon">
							<div class="intel_sline">
								...
								<div class="intel_solo">
									<label>关键字：</label> <input type="text" id="yard_keyword">
								</div>
								<div class="intel_solo">
						...
						<div class="alt_edit">
							<div class="alt_edit_div">
								<label>编号：</label> <input type="text" value="121221"
									id="yard_code" readonly="readonly">
							</div>
							<div class="alt_edit_div">
								<label>名称：</label> <input type="text" id="yard_name">
							</div>
							<div class="alt_edit_div">
								<label>有效性：</label> <input type="checkbox" id="yard_isvalid"><span>有效</span>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="alt_edit">
							...
							<div class="alt_edit_div">
								<label>名称：</label> <input type="text" id="update_yard_name">
							</div>
							<div class="alt_edit_div">
								<label>有效性：</label> <input type="checkbox"
									id="update_yard_isvalid"><span>有效</span>
							</div>
							<div class="alt_edit_textarea">
								<label>备注： </label>
