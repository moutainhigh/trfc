					...
					<div class="modal-body">
						<div class="alt_edit">
							<div class="alt_edit_div">
								<label>运输单位编号：</label> <input type="text" readonly="true"
									value="11" id="transport_code">
							</div>
							<div class="alt_edit_div">
								<label>运输单位内码：</label> <input type="text" readonly="true"
									value="11" id="transport_internalcode">
							</div>
							<div class="alt_edit_div">
								<label>运输单位名称：</label> <input type="text" id="transport_name">
							</div>
							<div class="alt_edit_div">
								<label>运输单位简称：</label> <input type="text"
									id="transport_abbrname">
							</div>
							<div class="alt_edit_div">
								<label>地址：</label> <input type="text" id="transport_address">
							</div>
							<div class="alt_edit_div">
								<label>电话：</label> <input type="text" id="transport_telephone">
							</div>
							<div class="alt_edit_div">
								<label>所属组织：</label> <input id="transport_orgname" type="text">
							</div>
							<div class="alt_edit_div">
								<label>有效性：</label> <input type="checkbox"
									id="transport_isvalid"><span>有效</span>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="alt_edit">
							<div class="alt_edit_div">
								<label>运输单位编号：</label> <input type="text" readonly="true"
									value="00" id="update_transport_code">
							</div>
							<div class="alt_edit_div">
								<label>运输单位内码：</label> <input type="text" readonly="true"
									value="11" id="update_transport_internalcode">
							</div>
							<div class="alt_edit_div">
								<label>运输单位名称：</label> <input type="text"
									id="update_transport_name">
							</div>
							<div class="alt_edit_div">
								<label>运输单位简称：</label> <input type="text"
									id="update_transport_abbrname">
							</div>
							<div class="alt_edit_div">
								<label>地址：</label> <input type="text"
									id="update_transport_address">
							</div>
							<div class="alt_edit_div">
								<label>电话：</label> <input type="text"
									id="update_transport_telephone">
							</div>
							<div class="alt_edit_div">
								<label>所属组织：</label> <input id="update_transport_orgname"
									type="text">
							</div>
							<div class="alt_edit_div">
								<label>有效性：</label> <input type="checkbox"
									id="update_transport_isvalid"><span>有效</span>
							</div>
							<div class="alt_edit_textarea">
								<label>备注： </label>
								<textarea class="form-control" rows="1"
									id="update_transport_remarks"></textarea>
							</div>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-primary"
							id="update_transport">确定</button>
						<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					</div>
				</div>
			</div>
