...
<link href="${staticBasePath}/css/layer.css" rel="stylesheet">
<link href="${staticBasePath}/css/simpleTree.css" rel="stylesheet">
...
<script type="text/javascript" src="${staticBasePath}/js/layui/layui.js"></script>
