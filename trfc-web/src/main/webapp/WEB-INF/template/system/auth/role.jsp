									...
									<tbody id="roles">
										<tr>
											...
											<td><span> <a data-toggle="modal"
												...
												<span> <a data-toggle="modal" data-target="#dele"><i
						...
						<div class="alt_edit">
							...
							<div class="alt_edit_div">
								<label>选项：</label> <input type="checkbox" id="isvalid"><span
									style="margin: 0 15px 0 0.8px;">有效</span> <input
									type="checkbox" id="allow_edit"><span
									style="margin: 0 15px 0 0.8px;">允许编辑</span> <input
									type="checkbox" id="allow_del"><span
						...
						<div class="alt_edit">
							...
							<div class="alt_edit_div">
								<label>选项：</label> <input type="checkbox" id="update_isvalid"><span
									style="margin: 0 15px 0 0.8px;">有效</span> <input
									type="checkbox" id="update_edit"><span
									style="margin: 0 15px 0 0.8px;">允许编辑</span> <input
									type="checkbox" id="update_del"><span
									style="margin: 0 15px 0 0.8px;">允许删除</span>
							</div>
							<div class="alt_edit_textarea">
								<label>描述： </label>
