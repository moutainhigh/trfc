            ...
            <div class="intel_search">
                ...
                <div class="intel_sconditon">
                    <div class="intel_sline">
                        ...
                        <div class="intel_solo">
						<label>组织编码：</label>
                            <input type="text" placeholder="请输入组织编码" id="orgId">	
						</div>
                        <div class="intel_solo">
						<label>组织名称：</label>
                            <input type="text" placeholder="请输入组织名称" id="orgName">	
						</div>            
                        <div class="intel_solo">
                            <label>客户编码：</label>
                            <input type="text" placeholder="请输入客户编码" id="customerId">
                        </div>
                        <div class="intel_solo">
                            <label>客户名称：</label>
                            <input type="text" placeholder="请输入客户名称" id="customerName">
                        </div>
                        <div class="intel_solo">
    ...
    <div class="modal-dialog" role="document" style="width: 850px;">
        <div class="modal-content">
            ...
            <!-- orgId 组织编码   orgName 组织名称  customerId 客户编码  customerName 客户名称
							break;        nlimitmny 信用额度    nengrossmny 信用占用  nbalancemny 信用余额 corigcurrencyid 币种
						default:			creator 创建人   createtime 创建时间 -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alt_edit">
                    <div class="alt_edit_div">
                        <label>组织编码：</label>
                        <input type="text"  readonly="true" id="detail_orgId">
                    </div>
                    <div class="alt_edit_div">
                        <label> 组织名称：</label>
                        <input type="text"  readonly="true" id="detail_orgName">
                    </div>
                    <div class="alt_edit_div">
                        <label>创建日期：</label>
                    ...
                    <div class="alt_edit_div">
                        <label>客户编码：</label>
                        <input type="text" id="detail_customerId" readonly="readonly">
                    </div>
                    <div class="alt_edit_div">
                        <label>客户名称：</label>
                        <input type="text" id="detail_customerName" readonly="readonly">
                    </div>
                    <div class="alt_edit_div">
                        <label>信用额度：</label>
                        <input type="text"  readonly="true" id="detail_nlimitmny">
                    </div>
                    <div class="alt_edit_div">
                        <label>信用占用：</label>
                        <input type="text" id="detail_nengrossmny" readonly="readonly">
                    </div>
                    <div class="alt_edit_div">
                        <label>信用余额：</label>
                        <input type="text" id="detail_nbalancemny" readonly="readonly">
                    </div>
                    <div class="alt_edit_div">
                        <label>币 种：</label>
...
<script type="text/javascript"
		src="/javascript/businessManage/financeManage/customerRemainder.js"></script>
