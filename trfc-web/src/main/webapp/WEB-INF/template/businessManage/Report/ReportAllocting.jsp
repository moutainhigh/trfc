...
<body>
	<div class="it_admin">
		...
		<div class="right">
            ...
            <div class="intel_solo">
			    ...
			    <option value="0" selected >计量系统</option>
    ...
    <div class="wuliao_opera" style="position:relative;">
        <div class="wuliao_tab tj_tab">
            <ul>  
            	<li id="yard" data-type="4">调出调入</li>
        ...
        <div class="wuliao_tabcont hide_yard">
		...
		<!--分页效果结束-->
			...
			<script type="text/javascript"
				src="/javascript/businessManage/Report/ReportAllocting.js?2018010301"></script>  
			<script type="text/javascript"
				src="/javascript/businessManage/Report/ReportAllocting2.js?2018010301"></script> 
</body>
</html>