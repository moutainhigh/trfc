...
<body>
				...
				<div class="intel_tabcont ">
					...
					<div class="daohuo_add">
						...
						<div class="daohuo_add_div">
							...
							<div class="daohuo_add_solo">
								<label><em class="colorred">*</em>制单日期：</label> <input id="makebilltime" type="text"
									value="${nowDate }" readonly="readonly"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})"
									class="Wdate_add" />
							</div>
							<div class="daohuo_add_solo">
								<label><em class="colorred">*</em>重车时间：</label> <input id="weighttime" type="text"
									value="${nowDate }" readonly="readonly"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})"
									class="Wdate_add" />
							</div>
							<div class="daohuo_add_solo">
								<label><em class="colorred">*</em>轻车时间：</label> <input id="lighttime" type="text"
									value="${nowDate }" readonly="readonly"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})"
									class="Wdate_add" />
							</div>
							<div class="daohuo_add_solo">
								<label><em class="colorred">*</em>制单人：</label> <input type="text" value="${makebillname }"
									readonly="true">
							</div>
						</div>
					</div>
	...
	<script type="text/javascript"
		src="/javascript/businessManage/poundNoteMaintain/cutoverPoundNoteAdd.js?20171223"></script>
</body>
</html>