...
<body>
	<div class="it_admin">
		...
		<div class="right">
			...
			<div class="intel_tab">
				<!--tab切换标题-->
				<ul class="intel_menu">
					<li><a href="/trfc/poundNote/purchase/main">采购磅单维护</a></li>
					<li class="select"><a href="/trfc/poundNote/sales/main">销售磅单维护</a></li>
				</ul>
			</div>
			<!--tab切换的内容-->
	...
	<script type="text/javascript"
		src="/javascript/businessManage/poundNoteMaintain/salesPoundNoteAdd.js"></script>
</body>
</html>