...
<body>
						  ...
						  <input id="poundNoteId" type="hidden" value="${poundNote.id }"/>
							<div class="daohuo_add_solo">
								...
								<div class="input_withlogo">
									<input id="billcode" type="text" placeholder="请选择订单" value="${poundNote.billcode }"
							...
							<div class="daohuo_add_solo">
								<label>供应商：</label> <input id="suppliername" type="text" value="${poundNote.suppliername }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>订单数量：</label> <input id="purchasesum" type="text" value="${poundNote.billsum }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>余量：</label> <input id="margin" type="text" value="${poundNote.margin }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
							...
							<div class="daohuo_add_solo">
								<label>净重：</label> <input id="netweight" type="text" value="${poundNote.netweight }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>原发净重：</label> <input id="originalnetweight" type="text" value="${poundNote.originalnetweight }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>车号：</label> <input id="vehicle" type="text" value="${poundNote.vehicleno }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>物料：</label> <input id="materielname" type="text" value="${poundNote.materielname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>司机：</label> <input id="driver" type="text" value="${poundNote.drivername }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>身份证：</label> <input id="driveridentityno" type="text" value="${poundNote.driveridentityno }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>仓库：</label> <input id="warehouse" type="text" value="${poundNote.warehousename }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>矿口：</label> <input id="minemouth" type="text" value="${poundNote.minemouthname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>堆场：</label> <input id="yard" type="text" value="${poundNote.yardname }" readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>收料员：</label> <input id="receiverperson" type="text" value="${poundNote.receiverpersonname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>重车时间：</label> <input id="weighttime" type="text" value="${poundNote.weighttimeStr }"
									readonly="true"/>
							</div>
							<div class="daohuo_add_solo">
								<label>轻车时间：</label> <input id="lighttime" type="text" value="${poundNote.lighttimeStr }"
									readonly="true"/>
							</div>
							<div class="daohuo_add_solo">
								<label>供应商备注：</label> <input id="supplierremark" type="text" value="${poundNote.supplierremark }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>制单日期：</label> <input id="makebilltime" type="text" value="${poundNote.makebilltimeStr }"
									readonly="true"/>
							</div>
							<div class="daohuo_add_solo">
	...
	<script type="text/javascript"
		src="/javascript/businessManage/poundNoteMaintain/purchaseCopyView.js?2017122801"></script>
</body>
</html>
