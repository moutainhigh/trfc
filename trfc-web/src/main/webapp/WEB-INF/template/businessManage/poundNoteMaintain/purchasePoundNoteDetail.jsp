			...
			<div class="intel_tabbox">
				...
				<div class="intel_tabcont ">
					<div class="intel_search">
						...
						<div class="alt_opera">
							<ul>
								<li onclick="window.location.reload();"><i class="iconfont colorlv">&#xe61b;</i>
									<h5>刷新</h5></li>
							</ul>
						</div>
					</div>
					<div class="daohuo_add">
						...
						<div class="daohuo_add_div">
							...
							<div class="daohuo_add_solo">
								<label>供应商：</label> <input type="text" value="${poundNote.suppliername }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>订单号：</label> <input type="text" value="${poundNote.billcode }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>物料：</label> <input type="text" value="${poundNote.materielname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
							...
							<div class="daohuo_add_solo">
								<label>到货通知单：</label> <input type="text" value="${poundNote.noticecode }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>收料员：</label> <input type="text" value="${poundNote.receiverpersonname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>收货时间：</label> <input type="text" value="${poundNote.receivertimeStr }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>原发数量：</label> <input type="text" value="${poundNote.originalnetweight }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>扣重：</label> <input type="text" value="${poundNote.deductionweight }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>扣杂：</label> <input type="text" value="${poundNote.deductionother }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>矿口：</label> <input type="text" value="${poundNote.minemouthname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>堆场：</label> <input type="text" value="${poundNote.yardname }"
									readonly="true">
							</div>
							<div class="daohuo_add_solo">
								<label>供应商备注：</label> <input type="text" value="${poundNotesupplierremark.supplierremark }"
									readonly="true">
							</div>
						</div>
					</div>
