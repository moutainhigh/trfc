...
<body>
			...
			<div class="intel_tabbox">
				...
				<div class="intel_tabcont">
					...
					<div class="intel_table">
						<!--用户表格begin-->
						<table class=" table table-hover" id="myTable04" cellpadding="0"
							cellspacing="0">
							<thead>
								<tr>
									<th>序号</th>
	...
	<script type="text/javascript"
		src="/javascript/businessManage/poundNoteMaintain/cutoverPoundNote.js"></script>
</body>
</html>