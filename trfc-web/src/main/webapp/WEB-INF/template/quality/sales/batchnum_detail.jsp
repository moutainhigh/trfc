	...
	<div class="it_admin">
		...
		<div class="right">
			...
			<div class="intel_tab">
				<!--tab切换标题-->
				<ul class="intel_menu">
					<li class="select"><a href="">批号维护单详情</a></li>
				</ul>
				<!--tab切换标题end-->
				<div class="top_opera">
						...
						<div class="daohuo_add_div">
							...
							<div class="daohuo_add_solo">
								<label><span class="colorred">*</span>批号：</label> <input
									id="edit_factorycode" type="text" readonly="readonly">
							</div>
							<div class="daohuo_add_solo">
								<label><span class="colorred">*</span>数量：</label> <input
									id="edit_count" type="text" value="000" readonly="readonly">
							</div>
							<div class="daohuo_add_solo">
