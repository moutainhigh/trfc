...
<body>
				...
				<div class="intel_tabcont ">
						...
						<div class="alt_opera">
							<ul>
								<li id="fresh"><i class="iconfont colorlv">&#xe61b;</i>
									<h5>刷新</h5></li>
								<li id="save"><i class="iconfont colorblue" id="save">&#xe61d;</i>
									<h5>保存</h5></li>
					...
					<div class="daohuo_add">
						...
						<div class="daohuo_add_div">
							...
							<div class="daohuo_add_solo">
								<label>报告人：</label> <input type="text" id="edit_reporter">
							</div>
							<div class="daohuo_add_solo">
	...
	<script type="text/javascript"
		src="/javascript/quality/sales/assayReport_edit.js"></script>
</body>
</html>
