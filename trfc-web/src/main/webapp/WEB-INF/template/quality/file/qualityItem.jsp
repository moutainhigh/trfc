...
<div class="intel_search">
    ...
    <div class="intel_sconditon">
        ...
        <div class="intel_solo">
            <label>查询条件：</label>
            <select class="form-control" id="seek_condition">
            ...
            <div class="intel_solo">
                <label>类型：</label>
                <select class="form-control" id="seek_type">
            ...
            <div class="modal-body">
                <div class="alt_edit">
                    <div class="alt_edit_div">
                        <label class="colorred">*质检项目编号：</label>
                        <input type="text" readonly="true" value="z51512" id="add_code">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*质检项目名称：</label>
                        <input type="text" id="add_name">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*符号表示：</label>
                        <input type="text" id="add_ename">
                    </div>
                    <div class="alt_edit_div">
                        <label>单位名称：</label>
                        <input type="text" id="add_units">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*类型：</label>
                    ...
                    <div class="alt_edit_div">
                        <label>公式：</label>
                        <input type="text" id="add_formula">
                    </div>
                    <div class="alt_edit_div">
                        <label>有效性：</label>
                        <input type="checkbox" id="add_invlid"><span>有效</span>
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*值分组：</label>
                        <input type="text" id="add_vgroups">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*值类型：</label>
                        <select class="form-control" id="add_vtype">
                    ...
                    <div class="alt_edit_div">
                        <label class="colorred">*值天数：</label>
                        <select class="form-control"  id="add_vdays">
            ...
            <div class="modal-body">
                <div class="alt_edit">
                    ...
                    <input type="hidden" id="edit_id">
                        <label class="colorred">*质检项目编号：</label>
                        <input type="text" readonly="true" value="z51512" id="edit_code">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*质检项目名称：</label>
                    ...
                    <div class="alt_edit_div">
                        <label class="colorred">*符号表示：</label>
                        <input type="text" id="edit_ename">
                    </div>
                    <div class="alt_edit_div">
                        <label>单位名称：</label>
                        <input type="text" id="edit_units">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*类型：</label>
                    ...
                    <div class="alt_edit_div">
                        <label>公式：</label>
                        <input type="text" id="edit_formula">
                    </div>
                    <div class="alt_edit_div">
                        <label>有效性：</label>
                        <input type="checkbox" id="edit_invlid"><span>有效</span>
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*值分组：</label>
                        <input type="text" id="edit_vgroups">
                    </div>
                    <div class="alt_edit_div">
                        <label class="colorred">*值类型：</label>
                        <select class="form-control" id="edit_vtype">
                            <option value="0">单值</option>
                            <option value="1">平均</option>
                            <option value="2">其他</option>
                        </select>
                    ...
                    <div class="alt_edit_div">
                        <label class="colorred">*值天数：</label>
                        <select class="form-control"  id="edit_vdays">
                            <option value="0">单天</option>
                            <option value="1">3天</option>
                            <option value="2">28天</option>
                        </select>
