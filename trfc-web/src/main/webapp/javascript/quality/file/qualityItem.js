...
$(function() {
	...
	function initSelect() {
		...
		$("#add_line").autocomplete({
			...
			source : function(request, response) {
				...
				$.post(URL.columnAutoCompleteSearch, {
					type : $('#add_type').val()
				}, function(result) {
	...
	function contrast(obj1, obj2) {
		if (obj1.ename == obj2.ename && obj1.remark == obj2.remark
				&& obj1.name == obj2.name && obj1.type == obj2.type
				&& obj1.invlid == obj2.invlid && obj1.units == obj2.units
				&& obj1.line == obj2.line && obj1.formula == obj2.formula
				&& obj1.vgroups == obj2.vgroups && obj1.vdays == obj2.vdays
