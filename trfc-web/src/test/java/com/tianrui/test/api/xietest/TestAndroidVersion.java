...
public class TestAndroidVersion {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/version";
	...
	static ApiParam<AppVersionParam> getParam0(){
		ApiParam<AppVersionParam> api =new ApiParam<AppVersionParam>();
		
		AppVersionParam req =new AppVersionParam();
		req.setPhoneType("ios");
		req.setVersion("1.0");
