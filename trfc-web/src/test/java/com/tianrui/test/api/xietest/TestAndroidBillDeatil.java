...
public class TestAndroidBillDeatil {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/bill/detail";
	...
	static ApiParam<BillListParam> getParam0(){
		ApiParam<BillListParam> api =new ApiParam<BillListParam>();
		
		BillListParam req =new BillListParam();
		req.setId("");
		req.setDetailId("");
