...
public class TestAndroidMaterialSearch {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/material/search";
	...
	static ApiParam<SearchKeyParam> getParam0(){
		ApiParam<SearchKeyParam> api =new ApiParam<SearchKeyParam>();
		
		SearchKeyParam req =new SearchKeyParam();
