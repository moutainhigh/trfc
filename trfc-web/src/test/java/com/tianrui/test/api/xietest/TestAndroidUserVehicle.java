...
public class TestAndroidUserVehicle {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/user/vehicle";
	...
	static ApiParam<MyVehicleListParam> getParam0(){
		ApiParam<MyVehicleListParam> api =new ApiParam<MyVehicleListParam>();
		
		MyVehicleListParam req =new MyVehicleListParam();
		req.setPageSize(10);
