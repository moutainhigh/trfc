...
public class TestApiLeaveDoorSystem {

	private static String domin = "http://localhost/";
	//private static String domin = "http://172.19.4.97:28080/";
	private static String uri_enterFactoryCheck = "api/doorSystem/record";
	...
	static ApiParam<ApiDoorSystemSave> getParam0(){
		...
		req.setNotionformcode("DH201711160402");
		req.setType("2");
