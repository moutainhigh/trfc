...
public class TestAndroidSaveDriver {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/save/driver";
	...
	static ApiParam<DriverSave> getParam0(){
		ApiParam<DriverSave> api =new ApiParam<DriverSave>();
		
		DriverSave req =new DriverSave();
		req.setName("马云");
		req.setAbbrName("马大爷");
		req.setTelephone("15003888888");
		req.setIdNo("231281198908191521");
