...
public class TestAndroidHome {
	...
	static ApiParam<HomePageParam> getParam0(){
		ApiParam<HomePageParam> api =new ApiParam<HomePageParam>();
		
		HomePageParam req =new HomePageParam();
