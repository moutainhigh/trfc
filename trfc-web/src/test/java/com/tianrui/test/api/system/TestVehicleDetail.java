...
public class TestVehicleDetail {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.16.2.99:28080/";
	private static String uri_vehicleDetail = "api/vehicle/vehicleDetail";
	
	public static void main(String[] args) throws Exception {
		URL url = new URL(domin + uri_vehicleDetail);
		// 打开url连接
