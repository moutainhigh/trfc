...
public class TestAndroidMyPnDetail {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/my/pn/detail";
	...
	static ApiParam<MyPnListParam> getParam0(){
		ApiParam<MyPnListParam> api =new ApiParam<MyPnListParam>();
		
		MyPnListParam req =new MyPnListParam();
		req.setId("CK201711070001");
