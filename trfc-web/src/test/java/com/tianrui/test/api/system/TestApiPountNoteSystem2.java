...
public class TestApiPountNoteSystem2 {
	...
	static ApiParam<ApiPoundNoteQuery> getParam0() {
		...
		req.setRfid("E2000016130B017521903447");
		req.setVehicleno("豫Q22222");
		req.setType("1");
		req.setLimit(10);
