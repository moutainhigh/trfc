...
public class TestAndroidNoticeDetail {

	//private static String domin = "http://localhost/";
	private static String domin = "http://172.19.4.97:28080/";
	private static String uri_login = "api/android/static_new/notice/detail";
	...
	static ApiParam<NoticeListParam> getParam0(){
		ApiParam<NoticeListParam> api =new ApiParam<NoticeListParam>();
		
		NoticeListParam req =new NoticeListParam();
		req.setId("CD201711140003");
