...
/**
 * @Description 销售通知单和销售订单一对多关系表
 * @author zhanggaohao
 * @version 2017年3月11日 下午2:27:50
 */
public class SalesApplicationJoinNatice {
	//主键id
    private String id;
	//订单id
    ...
    public String getNaticeid() {
        return naticeid;
    }

    public void setNaticeid(String naticeid) {
        this.naticeid = naticeid == null ? null : naticeid.trim();
    }
