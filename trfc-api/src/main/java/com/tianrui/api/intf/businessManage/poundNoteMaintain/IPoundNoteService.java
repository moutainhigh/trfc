...
public interface IPoundNoteService {
	 ...
	 * @return
	 */
	Result invalid(PoundNoteQuery query);
	...
	/**
	 * @Description 其他榜单分页查询
	 * @author zhanggaohao
	 * @version 2017年5月22日 上午10:24:17
	 * @param query
	 * @return
	 * @throws Exception
	 */
	PaginationVO<PoundNoteResp> otherPoundNotePage(PoundNoteQuery query) throws Exception;
	/**
	 * @Description 厂内倒运榜单新增
	 * @author zhanggaohao
	 * @version 2017年5月22日 下午3:26:29
	 * @param save
	 * @return
	 * @throws Exception 
	 */
	Result cutoverAdd(PoundNoteSave save) throws Exception;
	/**
	 * @Description 其他入库榜单新增
	 * @author zhanggaohao
	 * @version 2017年5月23日 上午10:05:54
	 * @param save
	 * @return
	 * @throws Exception
	 */
	Result otherIntoAdd(PoundNoteSave save) throws Exception;
	/**
	 * @Description 其他出库榜单新增
	 * @author zhanggaohao
	 * @version 2017年5月23日 上午10:54:37
	 * @param save
	 * @return
	 * @throws Exception
	 */
